...
srand(time(NULL)); //Seed for random numbers
 ...
 numbers = fopen("numbers_fft8.txt", "r");
 results = fopen("results_eh_8p.txt", "r"); 
 bin_file = fopen("binary_FFT8point.txt", "w");
 log_file = fopen("LogFile_fft8p.txt", "w");
 results_initial = fopen("results_dsp_fft8p.txt", "w");
...
for (i = 0; i < Num_Iterations; i++)
  ...
  fprintf(log_file, "A0,B0,A1,B1,A2,B2,A3,B3,,R X0,R X1,R X2,R X3,R X4,R X5,R X6,R X7,,E X0, E X1, E X2, E x3,E x4,E x5,E x6,E x7 \n"); 
